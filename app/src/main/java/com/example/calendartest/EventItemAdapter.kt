...
class EventItemAdapter(): RecyclerView.Adapter<EventItemAdapter.ViewHolder>() {
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val textVisibility: TextView = view.findViewById(R.id.text_visible)
        val textRRule: TextView = view.findViewById(R.id.text_rrule)
        val textLocation: TextView = view.findViewById(R.id.text_location)
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): EventItemAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: EventItemAdapter.ViewHolder, position: Int) {
        ...
        holder.textStatus.text = CalendarUtil.getEventStatus(datum.status)
        holder.textAvailability.text = CalendarUtil.getEventAvailability(datum.availability)
        holder.textVisibility.text = datum.visible.toString()
