...
class CalendarActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        const val EXTRA_CALENDAR_ID = "com.example.calendartest.android.calendarprovider" +
                ".calendaractivity.extra"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fun getEvents(calendarId: String) {
            ...
            while (cur?.moveToNext() == true) {
                ...
                val availability = cur.getIntOrNull(PROJECTION_ALL_DAY_INDEX)
                val rRule = cur.getIntOrNull(PROJECTION_RRULE_INDEX)
        ...
        findViewById<RecyclerView>(R.id.recyclerViewEvents).let {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.item_container)) { v, insets ->
